...
test_that("Character method works as expected",{
    df <- getGcDistn(faFile, n = 100, readLength = 50, fragLength = 60, fragSd = 10, bins = 51)
...
test_that("Key parameters error correctly",{
    expect_error(getGcDistn(faFile, n = 100, readLength = 60, fragLength = 50))
    expect_error(getGcDistn(faFile, n = 100, readLength = 50, fragLength = 60, fragSd = 0))
})
