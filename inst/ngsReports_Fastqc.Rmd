...
plotSequenceQualities(rawFastqcData, labels = plotLabels, clusterNames = globals$clusterNames, dendrogram = globals$dendrogram, usePlotly = globals$usePlotly)
```

## Per Base Sequence Content

```{r plotSequenceContent, fig.cap = "Heatmap of summed base distributions along each read"}
plotSequenceContent(rawFastqcData, labels = plotLabels, clusterNames = globals$clusterNames, dendrogram = globals$dendrogram, usePlotly = globals$usePlotly)
```
...
plotAdapterContent(rawFastqcData, labels = plotLabels, usePlotly = globals$usePlotly) 
```

## Kmer Content

```{r plotKmers}
plotKmers(rawFastqcData, labels = plotLabels, usePlotly = globals$usePlotly, clusterNames = globals$clusterNames, dendrogram = globals$dendrogram)
```
