...
setMethod("fileName", "FastqcFile", 
          function(object){basename(object@path)})
...
#' @rdname fileName-methods
setMethod("fileName", "FastqcFileList", 
...
#' @rdname fileName-methods
setMethod("fileName", "FastqcDataList", 
