...
#'
#' @details \code{pwf} is an object of class PwfCols supplied with the package
...
#' (\code{rgb(0, 0.8, 0)}), yellow (\code{rgb(0.9, 0.9, 0.2)}), red
#' (\code{rgb(0.8, 0.2, 0.2)}) and white (\code{rgb(1, 1, 1)})
#'
#' @examples
