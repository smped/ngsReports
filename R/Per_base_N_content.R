...
setMethod("Per_base_N_content", "FastqcData", function(object){
...
#' @rdname Per_base_N_content
#' @aliases Per_base_N_content
setMethod("Per_base_N_content", "FastqcFileList", function(object){
    object <- getFastqcData(object)
    Per_base_N_content(object)
})
...
#' @rdname Per_base_N_content
#' @aliases Per_base_N_content
setMethod("Per_base_N_content", "character", function(object){
    object <- getFastqcData(object)
    Per_base_N_content(object)
})
