...
#'
#' @description Retrieve the Per Sequence GC Content module from one or more
#' FastQC reports
#'
...
setMethod("Per_sequence_GC_content", "FastqcData", function(object){
...
#' @rdname Per_sequence_GC_content
#' @aliases Per_sequence_GC_content
setMethod("Per_sequence_GC_content", "FastqcFile", function(object){
...
#' @rdname Per_sequence_GC_content
#' @aliases Per_sequence_GC_content
setMethod("Per_sequence_GC_content", "FastqcFileList", function(object){
    object <- getFastqcData(object)
    Per_sequence_GC_content(object)
})
...
#' @rdname Per_sequence_GC_content
#' @aliases Per_sequence_GC_content
setMethod("Per_sequence_GC_content", "character", function(object){
    object <- getFastqcData(object)
    Per_sequence_GC_content(object)
})
