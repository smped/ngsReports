...
#' @param targetsDF A data.frame with at least two columns named \code{Filename} 
#' and \code{Label}.
#' The filenames should match the original fastq files, and the labels should be 
#' simply alternative labels for these files for convenience.
...
#' package and create an HTML summary of all standard FASTQC plots for all files
