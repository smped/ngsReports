...
setMethod("getFastqcData", "FastqcFile",
          function(object){
              ...
              out[["Per_sequence_quality_scores"]] <-
                  getPerSeqQualScores(fqcLines)
              ...
              out[["Sequence_Length_Distribution"]] <-
                  getSeqLengthDist(fqcLines)
              ...
              Sequence_Duplication_Levels <- getSeqDuplicationLevels(
                  fqcLines
              )
