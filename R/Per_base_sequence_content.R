...
#'
#' @description Retrieve the Per Base Sequence Content module from one or more
#' FastQC reports
#'
...
setMethod("Per_base_sequence_content", "FastqcData", function(object){
...
#' @rdname Per_base_sequence_content
#' @aliases Per_base_sequence_content
setMethod("Per_base_sequence_content", "FastqcFile", function(object){
...
#' @rdname Per_base_sequence_content
#' @aliases Per_base_sequence_content
setMethod("Per_base_sequence_content", "FastqcFileList", function(object){
    object <- getFastqcData(object)
    Per_base_sequence_content(object)
})
...
#' @rdname Per_base_sequence_content
#' @aliases Per_base_sequence_content
setMethod("Per_base_sequence_content", "character", function(object){
    object <- getFastqcData(object)
    Per_base_sequence_content(object)
})
